...
/datum/map/yonaguni/perform_map_generation()
	map_submerged = TRUE
	admin_notice("<span class='warning'>Generating abyssal caves...</span>", R_DEBUG)
	sleep(-1)
	new /datum/random_map/automata/underwater_caves(null,1,1,1,255,255)
	admin_notice("<span class='warning'>Generating abyssal ore deposits...</span>", R_DEBUG)
	sleep(-1)
	new /datum/random_map/noise/ore(null,1,1,1,255,255)
	admin_notice("<span class='warning'>Generating abyssal flora...</span>", R_DEBUG)
	sleep(-1)
	new /datum/random_map/noise/seafloor/abyss(null,1,1,1,255,255)
	admin_notice("<span class='warning'>Generating sea floor...</span>", R_DEBUG)
	sleep(-1)
	new /datum/random_map/noise/seafloor(null,1,1,3,255,255)
