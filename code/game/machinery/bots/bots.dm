...
/obj/machinery/bot/attackby(var/obj/item/W, var/mob/user)
	if(W.isscrewdriver())
		if(!locked)
			open = !open
...
/obj/machinery/bot/attack_ai(var/mob/user)
...
/proc/LinkBlockedWithAccess(var/turf/A, var/turf/B, var/obj/item/card/id/ID)
