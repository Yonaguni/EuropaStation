...
/obj/machinery/telecomms/relay/Options_Menu()
	var/dat = ""
	if(src.z == TELECOMM_Z)
		dat += "<br>Signal Locked to Source: <A href='?src=\ref[src];change_listening=1'>[listening_level == STATION_Z ? "TRUE" : "FALSE"]</a>"
...
/obj/machinery/telecomms/relay/Options_Topic(href, href_list)
	...
	if(href_list["change_listening"])
		...
		if(result)
			...
			temp = "<font color = #666633>-% [src] could not lock it's signal onto the target. Two broadcasters or receivers required.</font>"
