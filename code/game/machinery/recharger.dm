...
obj/machinery/recharger
	...
	var/list/allowed_devices = list(/obj/item/weapon/gun/energy, /obj/item/weapon/gun/composite, /obj/item/weapon/melee/baton, /obj/item/weapon/cell, /obj/item/modular_computer)
