...
/obj/machinery/atmospherics/unary/cryo_cell/proc/process_occupant()
	...
	if(occupant)
		...
		if(occupant.bodytemperature < T0C)
			...
			if(air_contents.gas[MATERIAL_OXYGEN] > 2)
		...
		var/has_cryo = occupant.reagents.get_reagent_amount(REAGENT_CRYOXADONE) >= 1
		var/has_clonexa = occupant.reagents.get_reagent_amount(REAGENT_CLONEXADONE) >= 1
