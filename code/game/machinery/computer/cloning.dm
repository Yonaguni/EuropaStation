...
/obj/machinery/computer/cloning/attackby(obj/item/W as obj, var/mob/user)
...
/obj/machinery/computer/cloning/attack_ai(var/mob/user)
	return attack_hand(user)

/obj/machinery/computer/cloning/attack_hand(var/mob/user)
...
/obj/machinery/computer/cloning/Topic(href, href_list)
	...
	if ((href_list["scan"]) && (!isnull(src.scanner)))
		...
		if (src.menu == 3) //If we are viewing a record, confirm deletion
			...
			if (istype(C)||istype(C, /obj/item/device/radio/headset/pda))
...
/obj/machinery/computer/cloning/proc/scan_mob(var/mob/living/carbon/human/subject)
