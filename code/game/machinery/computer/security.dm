...
/obj/machinery/computer/secure_data/attackby(obj/item/O as obj, var/mob/user)
...
/obj/machinery/computer/secure_data/attack_ai(var/mob/user)
	return attack_hand(user)

//Someone needs to break down the dat += into chunks instead of long ass lines.
/obj/machinery/computer/secure_data/attack_hand(var/mob/user)
	if(..())
		return
	ui_interact(user)
...
/obj/machinery/computer/secure_data/ui_interact(user)
	if (src.z > 6)
		user << "<span class='warning'>Unable to establish a connection:</span> You're too far away from the ship!"
		return
	var/dat
