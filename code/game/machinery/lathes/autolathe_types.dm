...
/obj/machinery/autolathe/heavy
	...
	stored_material =  list("steel" = 0, "glass" = 0, "plastic" = 0, "osmium" = 0, "uranium" = 0, "diamond" = 0)
	storage_capacity = list("steel" = 0, "glass" = 0, "plastic" = 0, "osmium" = 0, "uranium" = 0, "diamond" = 0)
