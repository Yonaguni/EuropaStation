...
/obj/machinery/microwave/attack_ai(var/mob/user)
	if(istype(user, /mob/living/silicon/robot) && Adjacent(user))
		attack_hand(user)

/obj/machinery/microwave/attack_hand(var/mob/user)
...
/obj/machinery/microwave/interact(var/mob/user) // The microwave Menu
	var/dat = ""
	if(src.broken > 0)
