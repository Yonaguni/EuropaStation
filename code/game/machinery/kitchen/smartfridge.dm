...
/obj/machinery/smartfridge/secure/virology/accept_check(var/obj/item/O)
...
/obj/machinery/smartfridge/attack_ai(var/mob/user)
	attack_hand(user)

/obj/machinery/smartfridge/attack_hand(var/mob/user)
