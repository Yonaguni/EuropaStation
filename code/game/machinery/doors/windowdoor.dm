...
/obj/machinery/door/window/Bumped(var/atom/movable/AM)
	if (!( ismob(AM) ))
...
/obj/machinery/door/window/CheckExit(var/atom/movable/mover, turf/target as turf)
	if(istype(mover) && mover.checkpass(PASSGLASS))
		return 1
...
/obj/machinery/door/window/attack_ai(var/mob/user)
	return src.attack_hand(user)

/obj/machinery/door/window/attack_hand(var/mob/user)
...
/obj/machinery/door/window/attackby(var/obj/item/I, var/mob/user)
