		...
		switch(screen)
			...
			if(9)
				...
				if(src.viewing_channel.censored)
					dat+="<FONT COLOR='red'><B>ATTENTION: </B></FONT>This channel has been deemed as threatening to the welfare of the crew, and marked with a [company_name] D-Notice.<BR>"
...
/obj/item/weapon/newspaper
	name = "newspaper"
	desc = "An issue of The Copernican, the newspaper circulating aboard most spacecraft."
