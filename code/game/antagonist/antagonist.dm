/datum/antagonist
	...
	// Role data.
	var/id                                  // Unique datum identifier.
	...
	var/list/valid_species =       list(DEFAULT_SPECIES)
	...
	var/list/faction_members =     list()   // Semi-antags (in-round revs, thralls)

	// ID card stuff.
	var/default_access = list()
	var/id_type = /obj/item/card/id

	var/antag_text = "You are an antagonist! Try to act as an opposing force to the crew. Make it interesting!"
