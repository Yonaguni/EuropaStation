...
/datum/antagonist/mercenary
	...
	welcome_text = "To speak on the team's private channel use :t."
...
/datum/antagonist/mercenary/equip(var/mob/living/carbon/human/player)
	...
	player.equip_to_slot_or_del(new /obj/item/gun/composite/premade/revolver/preloaded/luna_arms(player), slot_belt)
	...
	if(player.backbag == 3) player.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel_norm(player), slot_back)
