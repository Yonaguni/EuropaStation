/datum/news_announcement
	...
	var/author = "Editor"
	var/channel_name = "The Copernican"
	var/can_be_redacted = 0
	var/message_type = "Story"

/datum/news_announcement/placeholder
	round_time = 60*10
	message = "This has been a test of the emergency news announcement system. Please do not be alarmed."
	author = "SYSTEM"

var/list/newscaster_standard_feeds = list(/datum/news_announcement/placeholder)
