...
/obj/machinery/embedded_controller/radio/docking_port_multi/ui_interact(mob/user, ui_key = "main", datum/tgui/ui = null, var/force_open = 1)
	var/data[0]
...
/obj/machinery/embedded_controller/radio/airlock/docking_port_multi/ui_interact(mob/user, ui_key = "main", datum/tgui/ui = null, var/force_open = 1)
	var/data[0]
