	...
	switch(state)
		...
		if(3)
			...
			if(istype(P, /obj/item/weapon/aiModule/nanotrasen))
				laws.add_inherent_law("Safeguard: Protect your assigned facility to the best of your ability. It is not something we can easily afford to replace.")
				laws.add_inherent_law("Serve: Serve the crew of your assigned facility to the best of your abilities, with priority as according to their rank and role.")
				laws.add_inherent_law("Protect: Protect the crew of your assigned facility to the best of your abilities, with priority as according to their rank and role.")
...
/client/proc/empty_ai_core_toggle_latejoin()
	...
	var/list/cores = list()
	for(var/obj/structure/AIcore/deactivated/D in all_structures)
		cores["[D] ([D.loc.loc])"] = D
