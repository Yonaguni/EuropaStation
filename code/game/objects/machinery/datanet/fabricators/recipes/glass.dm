...
/decl/fabricator_design/glass/bulb/tube
	name = "light tube"
	path = /obj/item/weapon/light/tube

/decl/fabricator_design/glass/general
	name = "glass ashtray"
