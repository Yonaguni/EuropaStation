...
/obj/structure/windoor_assembly/CheckExit(var/atom/movable/mover, turf/target as turf)
	if(istype(mover) && mover.checkpass(PASSGLASS))
		return 1
...
/obj/structure/windoor_assembly/attackby(obj/item/W as obj, var/mob/user)
