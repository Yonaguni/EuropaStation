...
/obj/item/taperecorder/hear_talk(var/mob/living/M, msg, var/verb="says", datum/language/speaking=null)
	if(mytape && recording)
...
/obj/item/taperecorder/see_emote(var/mob/M, text, var/emote_type)
