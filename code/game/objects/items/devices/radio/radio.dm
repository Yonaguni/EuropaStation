...
/obj/item/radio/attack_self(var/mob/user)
...
/obj/item/radio/proc/handle_message_mode(var/mob/living/M, message, message_mode)
...
/obj/item/radio/talk_into(var/mob/living/M, message, channel, var/verb = "says", var/datum/language/speaking = null)
...
/obj/item/radio/hear_talk(var/mob/M, msg, var/verb = "says", var/datum/language/speaking = null)
...
/obj/item/radio/attackby(var/obj/item/W, var/mob/user)
	..()
	user.set_machine(src)
	if (!( W.isscrewdriver() ))
		return
...
/obj/item/radio/borg/attackby(var/obj/item/W, var/mob/user)
//	..()
	user.set_machine(src)
...
/obj/item/radio/borg/interact(var/mob/user)
	if(!on)
		return
