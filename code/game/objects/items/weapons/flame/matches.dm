...
/obj/item/weapon/storage/box/matches/stormproof
	name = "\improper 'Stormproof' matchbox"
	match_type = /obj/item/weapon/flame/match/waterproof
	match_count = 6
...
/obj/item/weapon/flame/match/waterproof
	name = "waterproof match"
	desc = "A simple magnesium-based waterproof match."
	waterproof = 1
