...
/obj/item/weapon/aiModule/protectStation/addAdditionalLaws(var/mob/living/silicon/ai/target, var/mob/sender)
	var/law = "Protect the vessel against damage. Anyone you see harming the vessel is no longer to be considered a crew member, and is a threat which must be neutralized."
...
/obj/item/weapon/aiModule/quarantine
	...
	desc = "A 'quarantine' AI module: 'The vessel is under a quarantine. Do not permit anyone to leave. Prevent, by any means necessary, crew members from leaving. It is impossible to harm crew members while preventing them from leaving.'."


/obj/item/weapon/aiModule/quarantine/addAdditionalLaws(var/mob/living/silicon/ai/target, var/mob/sender)
	var/law = "The vessel is under a quarantine. Do not permit anyone to leave. Prevent, by any means necessary, crew members from leaving. It is impossible to harm crew members while preventing them from leaving."
...
/obj/item/weapon/aiModule/oxygen
	...
	desc = "A 'OxygenIsToxicToCrewMembers' AI module: 'Oxygen is highly toxic to crew members, and must be purged from the vessel. Prevent, by any means necessary, anyone from exposing the vessel to this toxic gas. Extreme cold is the most effective method of healing the damage Oxygen does to a crew member.'."


/obj/item/weapon/aiModule/oxygen/addAdditionalLaws(var/mob/living/silicon/ai/target, var/mob/sender)
	var/law = "Oxygen is highly toxic to crew members, and must be purged from the vessel. Prevent, by any means necessary, anyone from exposing the vessel to this toxic gas. Extreme cold is the most effective method of healing the damage Oxygen does to a crew member."
