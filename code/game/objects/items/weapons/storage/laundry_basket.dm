...
/obj/item/storage/laundry_basket/attack_hand(var/mob/user)
	if(ishuman(user))
...
/obj/item/storage/laundry_basket/attack_self(var/mob/user)
...
/obj/item/storage/laundry_basket/dropped(var/mob/user)
	qdel(linked)
	return ..()

/obj/item/storage/laundry_basket/show_to(var/mob/user)
	return

/obj/item/storage/laundry_basket/open(var/mob/user)
...
/obj/item/storage/laundry_basket/offhand/dropped(var/mob/user)
	..()
