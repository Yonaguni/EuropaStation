...
/obj/item/tank/jetpack
	...
	var/datum/effect/system/trail/ion/ion_trail
	var/on = 0.0
...
/obj/item/tank/jetpack/New()
	..()
	src.ion_trail = new /datum/effect/system/trail/ion()
...
/obj/item/tank/jetpack/proc/allow_thrust(num, var/mob/living/user)
	if(!(src.on))
		return 0
	...
	var/allgases = G.gas[MATERIAL_CO2] + G.gas[MATERIAL_NITROGEN] + G.gas[MATERIAL_OXYGEN] + G.gas[MATERIAL_FUEL]
	if(allgases >= 0.005)
		return 1
...
/obj/item/tank/jetpack/carbondioxide/New()
	..()
	air_contents.adjust_gas(MATERIAL_CO2, (6*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*T20C))
	return
...
/obj/item/tank/jetpack/rig/allow_thrust(num, var/mob/living/user)
