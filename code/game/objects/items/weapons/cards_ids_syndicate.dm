...
/obj/item/card/id/syndicate/New(var/mob/user)
	..()
...
/obj/item/card/id/syndicate/afterattack(var/obj/item/O, var/mob/user, proximity)
	if(!proximity) return
...
/obj/item/card/id/syndicate/attack_self(var/mob/user)
