...
/datum/game_mode/proc/send_intercept()
	...
	intercepttext += "<B>This is the daily automated Crew Intelligence Services Report. It has been generated by an automated system - do not reply to this message. Attached is a list of personnel whom CIS sources suspect may be affiliated with subversive elements:</B><br>"
