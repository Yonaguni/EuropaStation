...
/datum/universal_state/nuclear_explosion/OnEnter()
	...
	if(isStationLevel(T.z))
		world << "<span class='danger'>\The [station_name()] was destoyed by the nuclear blast!</span>"
		dust_mobs(using_map.station_levels)
		play_cinematic_station_destroyed()
	else
		world << "<span class='danger'>A nuclear device was set off, but the explosion was out of reach of \the [station_name()]!</span>"
		dust_mobs(list(T.z))
