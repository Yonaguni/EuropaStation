/datum/game_mode/ninja
	...
	extended_round_description = "What was that?! Was that a person or did your eyes just play tricks on you? \
		...
		through the defenses of the crew with technological capabilities eons ahead of your time. They can avoid \
		the omniscience of the AI and rival the most hardened weapons available. Tread lightly and \
