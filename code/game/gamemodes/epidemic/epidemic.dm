/datum/game_mode/epidemic
	...
	config_tag = "epidemic"
	required_players = 1
	round_description = "A deadly epidemic is spreading through the crew. Find a cure as fast as possible, and keep your distance to anyone who speaks in a hoarse voice!"
