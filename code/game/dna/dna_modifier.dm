...
/obj/machinery/dna_scannernew/proc/eject_occupant()
	...
	for(var/obj/O in src)
		if((!istype(O,/obj/item/weapon/reagent_containers)) && (!istype(O,/obj/item/weapon/circuitboard/clonescanner)) && (!istype(O,/obj/item/component)) && (!istype(O,/obj/item/stack/cable_coil)))
...
/obj/machinery/computer/scan_consolenew/attack_hand(user as mob)
  ...
  * @return nothing
  */
/obj/machinery/computer/scan_consolenew/ui_interact(mob/user, ui_key = "main", datum/tgui/ui = null, var/force_open = 1)
