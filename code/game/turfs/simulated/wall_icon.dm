/turf/simulated/wall/proc/update_material()
	...
	if(reinf_material)
		...
		desc = "It seems to be a wall reinforced with [reinf_material.display_name] and made of [material.display_name]."
	else
...
/turf/simulated/wall/update_icon(var/update_neighbors)
	...
	..(update_neighbors, previously_added = overlays_to_add)
