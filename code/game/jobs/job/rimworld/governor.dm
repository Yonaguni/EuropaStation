...
/datum/job/borderworld/governor/equip(var/mob/living/human/H, skip_suit = 0, skip_hat = 0, skip_shoes = 0, var/alt_rank)
...
/datum/job/borderworld/governor/equip_survival(var/mob/living/human/H)
	return ..()
