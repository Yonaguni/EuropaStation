...
/atom/proc/attack_ghost(var/mob/observer/ghost/user)
...
/obj/machinery/gateway/centerstation/attack_ghost(var/mob/user)
	if(awaygate)
		user.loc = awaygate.loc
	else
		user << "[src] has no destination."

/obj/machinery/gateway/centeraway/attack_ghost(var/mob/user)
	if(stationgate)
...
/*
/atom/proc/attack_admin(var/mob/user)
