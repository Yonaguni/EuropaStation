					...
					if(C.internal)
						...
						if(no_mask)
								...
								if(istype(tankcheck[i], /obj/item/tank))
									...
									switch(breathes)
										...
										if("nitrogen") 							//So we're a bit more picky about them.
											...
											if(t.air_contents.gas[MATERIAL_NITROGEN] && !t.air_contents.gas[MATERIAL_OXYGEN])
												contents.Add(t.air_contents.gas[MATERIAL_NITROGEN])
											else
												contents.Add(0)

										if (MATERIAL_OXYGEN)
											if(t.air_contents.gas[MATERIAL_OXYGEN] && !t.air_contents.gas[MATERIAL_FUEL])
												contents.Add(t.air_contents.gas[MATERIAL_OXYGEN])
											else
												contents.Add(0)

										// No races breath this, but never know about downstream servers.
										if ("carbon dioxide")
											if(t.air_contents.gas[MATERIAL_CO2] && !t.air_contents.gas[MATERIAL_FUEL])
												contents.Add(t.air_contents.gas[MATERIAL_CO2])
											else
												contents.Add(0)
							...
							if(C.internal)
								...
								C << "<span class='notice'>You don't have a[breathes==MATERIAL_OXYGEN ? "n oxygen" : addtext(" ",breathes)] tank.</span>"
		if("act_intent")
