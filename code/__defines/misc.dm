...
#define SHOW_TYPING     0x100
#define CHAT_RADIO      0x200
#define CHAT_ATTACKLOGS 0x400
#define CHAT_DEBUGLOGS  0x800
#define CHAT_NOICONS    0x1000
#define CHAT_GHOSTRADIO 0x2000
// unused 0x4000 0x8000

#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_LOBBY|CHAT_OOC|CHAT_DEAD|CHAT_GHOSTEARS|CHAT_GHOSTSIGHT|CHAT_RADIO|CHAT_ATTACKLOGS)
