...
// Higher == drawn first.
var/list/partial_uniform_layer_order = list(
	PARTIAL_UNIFORM_SKIN,
	PARTIAL_UNIFORM_FULL,
	PARTIAL_UNIFORM_UPPER,
	PARTIAL_UNIFORM_LOWER,
	PARTIAL_UNIFORM_OVER
	)
...
DEFINE_COLOR_VARIANT(##clothing_path, COLOR_NAVY,       navy,      "navy",       clothing_name); \
