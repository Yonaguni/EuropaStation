...
/obj/machinery/atmospherics/valve/attack_ai(var/mob/user)
	return

/obj/machinery/atmospherics/valve/attack_hand(var/mob/user)
...
/obj/machinery/atmospherics/valve/digital/attack_ai(var/mob/user)
	return src.attack_hand(user)

/obj/machinery/atmospherics/valve/digital/attack_hand(var/mob/user)
	if(!powered())
		return
	if(!src.allowed(user))
