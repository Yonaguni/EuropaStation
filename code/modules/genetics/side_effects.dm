...
/datum/genetics/side_effect/genetic_burn
	...
	finish(mob/living/carbon/human/H)
		if(!H.reagents.has_reagent(REAGENT_DEXALIN))
...
/datum/genetics/side_effect/bone_snap
	...
	treatment = "Inject small dose of styptazine."
	...
	finish(mob/living/carbon/human/H)
		if(!H.reagents.has_reagent(REAGENT_STYPTAZINE))
...
/*/datum/genetics/side_effect/monkey
	...
	finish(mob/living/carbon/human/H)
		if(!H.reagents.has_reagent(REAGENT_ANTITOXIN))
			H.monkeyize()**/
