...
/datum/nano_module/atmos_control/ui_interact(mob/user, ui_key = "main", datum/tgui/ui = null, var/force_open = 1, var/master_ui = null, var/datum/topic_state/state = default_state)
	var/data[0]
	var/alarms[0]
