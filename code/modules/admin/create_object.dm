...
/datum/admins/proc/quick_create_object(var/mob/user)
	...
	pathtext = input("Select the path of the object you wish to create.", "Path", "/obj") as null|anything in list("/obj","/obj/structure","/obj/item","/obj/item/weapon","/obj/item/clothing","/obj/machinery")
	if(!pathtext)
		return
