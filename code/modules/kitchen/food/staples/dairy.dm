/obj/item/reagent_containers/food/snacks/cheesewheel
	...
	slices_to = /obj/item/reagent_containers/food/snacks/cheesewedge
	slice_count = 5
	filling_color = "#FFF700"

/obj/item/reagent_containers/food/snacks/cheesewheel/initialize()
	..()
...
/obj/item/reagent_containers/food/snacks/chocolatechips
	name = "chocolate chip"
...
/obj/item/reagent_containers/food/snacks/chocolatechips/initialize()
	..()
	reagents.add_reagent(REAGENT_ID_NUTRIMENT, 2)
	reagents.add_reagent(REAGENT_ID_SUGAR, 2)
	reagents.add_reagent(REAGENT_ID_COCOA, 2)
