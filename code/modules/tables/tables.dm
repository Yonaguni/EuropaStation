...
/obj/structure/table/attackby(var/obj/item/W, mob/user)
...
/obj/structure/table/proc/remove_reinforced(var/obj/item/screwdriver/S, mob/user)
	reinforced = common_material_remove(user, reinforced, 40, "reinforcements", "screws", 'sound/items/Screwdriver.ogg')

/obj/structure/table/proc/remove_material(var/obj/item/wrench/W, mob/user)
	material = common_material_remove(user, material, 20, "plating", "bolts", 'sound/items/Ratchet.ogg')

/obj/structure/table/proc/dismantle(var/obj/item/wrench/W, mob/user)
...
/obj/structure/table/proc/break_to_parts(full_return = 0)
	...
	if(full_return || prob(20))
		...
		var/material/M = SSmaterials.get_material(MATERIAL_STEEL)
		S = M.place_shard(loc)
		if(S) shards += S
	qdel(src)
	return shards
