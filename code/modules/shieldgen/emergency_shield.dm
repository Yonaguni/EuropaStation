...
/obj/machinery/shield/attackby(var/obj/item/W, var/mob/user)
	if(!istype(W)) return
...
/obj/machinery/shieldgen/attack_hand(var/mob/user)
	if(locked)
...
/obj/machinery/shieldgen/attackby(var/obj/item/W, var/mob/user)
	if(W.isscrewdriver())
