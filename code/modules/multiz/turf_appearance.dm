...
/turf/simulated/open/proc/update_appearance()
	...
	if((corner_dirs & NORTHEAST) && !((neighbor_dirs & NORTH) || (neighbor_dirs & EAST)))
	...
	if((corner_dirs & SOUTHEAST) && !((neighbor_dirs & SOUTH) || (neighbor_dirs & EAST)))
	...
	if((corner_dirs & NORTHWEST) && !((neighbor_dirs & NORTH) || (neighbor_dirs & WEST)))
	...
	if((corner_dirs & SOUTHWEST) && !((neighbor_dirs & SOUTH) || (neighbor_dirs & WEST)))
