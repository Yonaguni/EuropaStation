/mob/living/mecha/proc/dismantle()
	var/obj/structure/mech_frame/frame = new(get_turf(src))
	frame.arms = arms
	frame.body = body
	frame.head = head
	frame.legs = legs
...
/mob/living/mecha/proc/install_system(var/obj/item/system, var/system_hardpoint, var/mob/user)
	...
	var/obj/screen/movable/snap/mecha/hardpoint/H = hardpoint_hud_elements[system_hardpoint]
	H.holding = system
...
/mob/living/mecha/proc/remove_system(var/system_hardpoint, var/mob/user)
