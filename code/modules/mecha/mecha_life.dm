/mob/living/mecha/handle_disabilities()
	return

/mob/living/mecha/handle_status_effects()
	return

/mob/living/mecha/Life()
...
/mob/living/mecha/handle_vision()
