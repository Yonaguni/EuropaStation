...
/obj/machinery/compressor/Process()
	...
	if(rpm>50000)
		overlays += image('icons/obj/pipes.dmi', "comp-o4")
	else if(rpm>10000)
		overlays += image('icons/obj/pipes.dmi', "comp-o3")
	else if(rpm>2000)
		overlays += image('icons/obj/pipes.dmi', "comp-o2")
	else if(rpm>500)
		overlays += image('icons/obj/pipes.dmi', "comp-o1")
	 //TODO: DEFERRED
...
/obj/machinery/power/turbine/Process()
	...
	if(lastgen > 100)
		overlays += image('icons/obj/pipes.dmi', "turb-o")
