...
/obj/machinery/power/attackby(var/obj/item/W, mob/user)
...
/proc/electrocute_mob(var/mob/living/carbon/M, var/power_source, var/obj/source, var/siemens_coeff = 1.0)
