...
/obj/machinery/power/solar/attackby(var/obj/item/W, mob/user)
...
/obj/item/solar_assembly/attackby(var/obj/item/W, var/mob/user)
	...
	if(!anchored && isturf(loc))
		...
		if(istype(W, /obj/item/stack/material) && (W.is_material(MATERIAL_GLASS) || W.is_material(MATERIAL_RGLASS)))
