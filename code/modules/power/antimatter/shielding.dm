...
/obj/machinery/am_shielding
	...
	desc = "This device was built using a life-form that seems to increase the generator's natural ability to react with neutrinos while reducing the combustibility."
...
/obj/item/am_shielding_container/attackby(var/obj/item/I, var/mob/user)
	if(I.ismultitool() && istype(src.loc,/turf))
