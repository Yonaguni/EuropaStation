...
/datum/antagonist/loyalists
	...
	faction_welcome = "Preserve Sol Central's interests against the traitorous recidivists amongst the crew. Protect the heads of staff with your life."
...
/datum/antagonist/loyalists/create_global_objectives()
	...
	for(var/mob/living/carbon/human/player in mob_list)
		if(!player.mind || player.stat==2 || !(player.mind.assigned_role in europa_head_positions))
			continue
