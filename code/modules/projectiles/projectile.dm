/obj/item/projectile
	...
	var/damage = 10
	var/damage_type = BRUTE //BRUTE, BURN, TOX, OXY, CLONE, subdual are the only things that should be in here
...
/obj/item/projectile/proc/attack_mob(var/mob/living/target_mob, var/distance, var/miss_modifier=0)
	...
	if(!no_attack_log)
		if(istype(firer, /mob))
			...
			msg_admin_attack("UNKNOWN shot [target_mob] ([target_mob.ckey]) with \a [src] [ADMIN_JUMP_LINK(target_mob.x,target_mob.y,target_mob.z)]")
