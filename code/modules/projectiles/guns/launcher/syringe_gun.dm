...
/obj/item/gun/launcher/syringe/attack_self(var/mob/living/user)
	if(next)
...
/obj/item/gun/launcher/syringe/attack_hand(var/mob/living/user)
...
/obj/item/gun/launcher/syringe/attackby(var/obj/item/A, var/mob/user)
