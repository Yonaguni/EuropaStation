...
/obj/item/gun/launcher/grenade/proc/pump(var/mob/M)
...
/obj/item/gun/launcher/grenade/proc/load(var/obj/item/grenade/G, mob/user)
...
/obj/item/gun/launcher/grenade/handle_post_fire(atom/movable/user)
	if(ismob(user))
		var/mob/M = user
...
/obj/item/gun/launcher/grenade/proc/can_load_grenade_type(var/obj/item/grenade/G, mob/user)
...
/obj/item/gun/launcher/grenade/underslung/load(var/obj/item/grenade/G, var/mob/user)
	if(!can_load_grenade_type(G, user))
		return
