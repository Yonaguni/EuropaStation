...
/obj/item/gun/launcher/pneumatic/attack_hand(var/mob/user)
	if(user.get_inactive_hand() == src)
		unload_hopper(user)
	else
		return ..()

/obj/item/gun/launcher/pneumatic/attackby(obj/item/W as obj, var/mob/user)
...
/obj/item/gun/launcher/pneumatic/attack_self(var/mob/user)
	eject_tank(user)
...
/obj/item/cannonframe/attackby(obj/item/W as obj, var/mob/user)
