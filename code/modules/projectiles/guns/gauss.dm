...
/obj/item/weapon/gun/railgun/pistol
	name = "rail pistol"
	desc = "1.5 megajoules of impact force in a package the size of a housecat. Keep the safety on when you jam it into your waistband."

/obj/item/weapon/gun/railgun/lmg
