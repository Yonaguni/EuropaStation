/obj/item/weapon/gun/magnetic/railgun
	name = "railgun"
	desc = "The LM-76 Thunderclap. A portable linear motor cannon produced during the Gaia Conflict for anti-armour and anti-fortification operations. Today, it sees wide use among private militaries, and is a staple on the black market."
...
/obj/item/weapon/gun/magnetic/railgun/tcc // Oppa! Should only be available to high-budget mercs.
	name = "advanced railgun"
	desc = "The HR-22 Hammerhead. A man-portable helical rail cannon; favorite weapon of shock troops and anti-tank personnel."
...
/obj/item/weapon/gun/magnetic/railgun/automatic // Adminspawn only, this shit is absurd.
	...
	desc = "The LMRA-14A Meteor. Originally a vehicle-mounted turret weapon used by the Confederation in the Gaia Conflict for anti-vehicular operations, the fact that it was made man-portable is mindboggling in itself."
