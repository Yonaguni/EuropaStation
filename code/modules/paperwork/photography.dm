...
/obj/item/camera/attack(var/mob/living/carbon/human/M, var/mob/user)
	return

/obj/item/camera/attack_self(var/mob/user)
	on = !on
	if(on)
...
/obj/item/camera/attackby(obj/item/I as obj, var/mob/user)
...
/obj/item/camera/afterattack(atom/target as mob|obj|turf|area, var/mob/user, flag)
...
/obj/item/camera/proc/printpicture(var/mob/user, var/obj/item/photo/p)
	p.loc = user.loc
