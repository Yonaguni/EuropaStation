...
/obj/item/paper/admin/proc/generateFooter()
	...
	text += "If this transmission is recieved in error, please notify both the sender and the office of [using_map.boss_name] Data Recovery immediately so that corrective action may be taken."
