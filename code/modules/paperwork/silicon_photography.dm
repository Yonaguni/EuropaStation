...
/obj/item/device/camera/siliconcam/proc/injectaialbum(var/obj/item/photo/p, var/sufix = "") //stores image information to a list similar to that of the datacore
	p.loc = src
	photos_taken++
	p.name = "Image [photos_taken][sufix]"
	aipictures += p

/obj/item/device/camera/siliconcam/proc/injectmasteralbum(var/obj/item/photo/p) //stores image information to a list similar to that of the datacore
...
/obj/item/device/camera/siliconcam/ai_camera/printpicture(var/mob/user, var/obj/item/photo/p)
	injectaialbum(p)
	usr << "<span class='unconscious'>Image recorded</span>"

/obj/item/device/camera/siliconcam/robot_camera/printpicture(var/mob/user, var/obj/item/photo/p)
	injectmasteralbum(p)
