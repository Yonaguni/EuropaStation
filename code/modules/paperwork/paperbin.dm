...
/obj/item/paper_bin/MouseDrop(var/mob/user)
...
/obj/item/paper_bin/attack_hand(var/mob/user)
	if(ishuman(user))
		var/mob/living/carbon/human/H = user
		var/obj/item/organ/external/temp = H.organs_by_name[BP_R_HAND]
		if (H.hand)
...
/obj/item/paper_bin/attackby(var/obj/item/paper/i as obj, var/mob/user)
	if(!istype(i))
		return
