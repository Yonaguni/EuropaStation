...
/obj/machinery/photocopier/attack_ai(var/mob/user)
	return attack_hand(user)

/obj/machinery/photocopier/attack_hand(var/mob/user)
...
/obj/machinery/photocopier/attackby(obj/item/O as obj, var/mob/user)
