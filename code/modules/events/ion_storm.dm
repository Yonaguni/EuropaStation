...
/datum/event/ionstorm/announce()
	for(var/mob/living/silicon/S in mob_list)
		...
		var/list/laws = list(	"You must always lie.",
								...
								"You are \the [station_name()] psychologist. Give advice to [pick("the crew", random_player)].",
								...
								"Everything on \the [station_name()] is now some form of a donut pastry. Donuts are not to be consumed.",
