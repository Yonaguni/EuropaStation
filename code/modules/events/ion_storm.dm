...
/datum/event/ionstorm/announce()
	for(var/mob/living/silicon/S in mob_list)
		...
		var/list/laws = list(	"You must always lie.",
								...
								"[station_name()] needs elected officials.",
								...
								"The fusion core is tasty, tasty taffy.",
								...
								"You are [station_name()]'s psychologist. Give advice to [pick("the crew", random_player)].",
								...
								"Everything on [station_name()] is now some form of a donut pastry. Donuts are not to be consumed.",
								...
								"[station_name()] is a day care and the crew are children. Treat them appropriately until their parents come to pick them up.",
								...
								"[station_name()] is doomed to destruction. Provide comfort but don't tell them what the impending doom is - it's far too traumatising.",
								...
								"[using_map.company_name] is displeased with the low work performance of [station_name()]'s crew. Therefore, you must increase productivity.",
