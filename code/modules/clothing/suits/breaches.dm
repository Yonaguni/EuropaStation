...
/datum/breach
	...
	var/obj/item/clothing/suit/holder // Suit containing the list of breaches holding this instance.
...
var/list/breach_brute_descriptors = list(
	"tiny puncture",
	"ragged tear",
	"large split",
	"huge tear",
...
var/list/breach_burn_descriptors = list(
	"small burn",
	"melted patch",
	"sizable burn",
	"large scorched area",
...
/obj/item/clothing/suit/proc/repair_breaches(var/damtype, var/amount, var/mob/user)
...
/obj/item/clothing/suit/proc/create_breaches(var/damtype, var/amount)
...
/obj/item/clothing/suit/proc/calc_breach_damage()
