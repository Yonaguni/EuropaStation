/obj/item/clothing/under/partial/pants
	name = "slacks"
...
/obj/item/clothing/under/partial/skirts/black
	name = "black skirt"
	desc = "A casual black skirt for around the office."
	icon_state = "skirt-black"

/obj/item/clothing/under/partial/skirts/skater
	name = "red skater skirt"
	desc = "Skates not included."
	icon_state = "skateskirt-red"

/obj/item/clothing/under/partial/skirts/skater/pink
	name = "pink skater skirt"
	desc = "Skates not included."
	icon_state = "skateskirt-pink"

/obj/item/clothing/under/partial/skirts/skater/blue
