...
/obj/item/clothing/mask/voice
	name = "gas mask"
	desc = "A face-covering mask that can be connected to an air supply. It seems to house some odd electronics."
	var/obj/item/voice_changer/changer

/obj/item/clothing/mask/voice/verb/Toggle_Voice_Changer()
	set category = "Object"
	set src in usr
...
/obj/item/clothing/mask/voice/verb/Set_Voice(name as text)
	set category = "Object"
	set src in usr
...
/obj/item/clothing/mask/voice/New()
	..()
	changer = new(src)
