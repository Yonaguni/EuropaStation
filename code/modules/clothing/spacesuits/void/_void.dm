/obj/item/clothing/head/helmet/space/void
	...
	desc = "A high-tech pressure suit helmet. Used for hostile environment maintenance."
	icon_state = "suit"
	...
	item_icons = list(
		slot_head_str = 'icons/mob/clothing/head_void.dmi',
...
/obj/item/clothing/suit/space/void
	...
	desc = "A high-tech pressure suit. Used for hostile environment maintenance."
	armor = list(melee = 40, bullet = 5, laser = 20,energy = 5, bomb = 35, bio = 100, rad = 20)
	...
	item_icons = list(
		slot_wear_suit_str = 'icons/mob/clothing/suits_void.dmi',
...
/obj/item/clothing/suit/space/void/attackby(obj/item/W as obj, var/mob/user)
