...
/mob/living/verb/ghost()
	...
	if(stat == DEAD)
		...
		message_admins("[key_name_admin(usr)] has ghosted. [ADMIN_JUMP_LINK(location.x,location.y,location.z)]")
...
/mob/dead/verb/bloody_doodle()
	...
	var/doodle_color = (choice.basecolor) ? choice.basecolor : DEFAULT_BLOOD_COLOUR
