...
/mob/living/bot/floorbot/attack_hand(var/mob/user)
	...
	var/dat
	dat += "<TT><B>Automatic Floor Repairer v1.0</B></TT><BR><BR>"
...
/obj/item/storage/toolbox/mechanical/attackby(var/obj/item/stack/tile/floor/T, var/mob/user)
...
/obj/item/toolbox_tiles/attackby(var/obj/item/W, var/mob/user)
	..()
	if(isprox(W))
		qdel(W)
...
/obj/item/toolbox_tiles_sensor/attackby(var/obj/item/W, var/mob/user)
	..()
