...
/obj/effect/landmark/mobcorpse
	...
	var/corpseidaccess = null //This is for access. See access.dm for which jobs give what access. Again, put in quotes. Use "Colony Director" if you want it to be all access.
