...
/mob/living/silicon/robot/drone/init()
	...
	flavor_text = "It's a tiny little repair drone. The casing is stamped with a corporate logo and the subscript: '[using_map.company_name] Recursive Repair Systems: Fixing Tomorrow's Problem, Today!'"
