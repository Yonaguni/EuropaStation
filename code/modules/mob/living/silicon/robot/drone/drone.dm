...
/mob/living/silicon/robot/drone
	name = "drone"
	real_name = "drone"
	icon = 'icons/mob/robots/drones.dmi'
...
/mob/living/silicon/robot/drone/init()
	...
	flavor_text = "It's a tiny little repair drone. The casing is stamped with \a [company_short] logo and the subscript: '[company_name] Recursive Repair Systems: Fixing Tomorrow's Problem, Today!'"
