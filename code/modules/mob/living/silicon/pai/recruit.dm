...
/datum/paiController/proc/recruitWindow(var/mob/M, allowSubmit = 1)
	...
	<body>
		...
		<table>
			...
			<tr class="d1">
				<td>What you plan to call yourself. Suggestions: Any character name you would choose for a character OR an AI.</td>
			</tr>
			<tr class="d0">
			...
			<tr class="d1">
				<td>Do you like to partner with sneaky social ninjas? Like to help security hunt down thugs? Enjoy watching an engineer's back while he saves the day yet again? This doesn't have to be limited to just crew jobs. Pretty much any general descriptor for what you'd like to be doing works here.</td>
			</tr>
			<tr class="d0">
