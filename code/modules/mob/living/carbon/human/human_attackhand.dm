...
/mob/living/carbon/human/attack_hand(var/mob/living/carbon/M)
...
/mob/living/carbon/human/proc/afterattack(var/atom/target, var/mob/living/user, inrange, params)
	return
