			...
			if(66 to 70)
				...
				if(!halbody)
					...
					if(possible_points.len)
						...
						switch(rand(1,4))
							if(1)
								halbody = image('icons/mob/creatures/human.dmi',target,"husk_l",TURF_LAYER)
							if(2,3)
								halbody = image('icons/mob/creatures/human.dmi',target,"husk_s",TURF_LAYER)
							if(4)
								halbody = image('icons/mob/creatures/alien.dmi',target,"alienother",TURF_LAYER)
	//						if(5)
