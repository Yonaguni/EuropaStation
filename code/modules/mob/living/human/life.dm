...
/mob/living/human/proc/get_pressure_weakness()
...
/mob/living/human/proc/handle_stasis_bag()
...
/mob/living/human/get_breath_from_internal(volume_needed=BREATH_VOLUME)
	if(internal)
