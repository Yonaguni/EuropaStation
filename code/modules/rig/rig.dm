...
/obj/item/weapon/rig
	...
	var/chest_type = /obj/item/clothing/suit/voidsuit/rig
	var/helm_type =  /obj/item/clothing/head/voidsuit/rig
	...
	var/obj/item/clothing/suit/voidsuit/rig/chest                // Deployable chestpiece, if any.
	var/obj/item/clothing/head/voidsuit/rig/helmet = null // Deployable helmet, if any.
...
/obj/item/weapon/rig/ui_interact(mob/user, ui_key = "main", datum/tgui/ui = null, var/force_open = 1, var/datum/ui_state/state = inventory_state)
	if(!user)
		return
...
/obj/item/weapon/rig/update_icon(var/update_mob_icon)
	...
	if(!mob_icon || update_mob_icon)
		var/species_icon = 'icons/mob/rigs/rig_back.dmi'
	...
	if(installed_modules.len)
		for(var/obj/item/rig_module/module in installed_modules)
			if(module.suit_overlay)
				chest.overlays += image("icon" = 'icons/mob/rigs/rig_modules.dmi', "icon_state" = "[module.suit_overlay]", "dir" = SOUTH)
...
/obj/item/weapon/rig/proc/check_suit_access(var/mob/living/human/user)
...
/obj/item/weapon/rig/equipped(mob/living/human/M)
	..()
...
/obj/item/weapon/rig/proc/malfunction_check(var/mob/living/human/user)
