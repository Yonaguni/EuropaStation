...
/obj/item/organ/internal/liver/process()
	...
	if(owner.life_tick % PROCESS_ACCURACY == 0)
		...
		if(owner.getToxLoss() >= 60 && !owner.reagents.has_reagent(REAGENT_ANTITOXIN))
		...
		if (src.damage && src.damage < src.min_bruised_damage && owner.reagents.has_reagent(REAGENT_ANTITOXIN))
			src.damage -= 0.2 * PROCESS_ACCURACY
