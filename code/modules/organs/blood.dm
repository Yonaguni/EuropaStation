...
/mob/living/carbon/human/proc/make_blood()
	...
	vessel.add_reagent(REAGENT_ID_BLOOD,(species.blood_volume * 0.95))
	spawn(1)
		fixblood()
...
/mob/living/carbon/human/handle_blood()
	...
	if(stat != DEAD && bodytemperature >= 170)	//Dead or cryosleep people do not pump the blood.
		...
		var/blood_volume = round(vessel.get_reagent_amount(REAGENT_ID_BLOOD)/species.blood_volume)*100 // Percentage.
...
/mob/living/carbon/human/proc/drip(var/amt as num)
	...
	vessel.remove_reagent(REAGENT_ID_BLOOD,amt)
...
/mob/living/carbon/human/take_blood(obj/item/weapon/reagent_containers/container, var/amount)
	...
	if(vessel.get_reagent_amount(REAGENT_ID_BLOOD) < amount)
		return null
