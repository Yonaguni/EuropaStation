...
/datum/seed/berry/poison/death
	...
	mutants = null
	chems = list(REAGENT_ID_NUTRIMENT = list(1), REAGENT_ID_TOXIN = list(3,3), "cyanide" = list(1,5))
...
/datum/seed/nettle
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1,50), "sacid" = list(0,1))
	kitchen_tag = "nettle"
	kitchen_tag = "nettle"
...
/datum/seed/nettle/death
	...
	mutants = null
	chems = list(REAGENT_ID_NUTRIMENT = list(1,50), REAGENT_ID_ACID = list(0,1))
...
/datum/seed/apple/poison
	name = "poisonapple"
	mutants = null
	chems = list(REAGENT_ID_TOXIN = list(1,5))
...
/datum/seed/ambrosia
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1), REAGENT_ID_TOXIN = list(1,10))
...
/datum/seed/ambrosia/deus
	...
	mutants = null
	chems = list(REAGENT_ID_NUTRIMENT = list(1), REAGENT_ID_JUMPSTART = list(1,10,1))
...
/datum/seed/mushroom/hallucinogenic
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1,50), "psilocybin" = list(3,5))
...
/datum/seed/mushroom/hallucinogenic/strong
	...
	mutants = null
	chems = list(REAGENT_ID_NUTRIMENT = list(1), REAGENT_ID_SLEEPTOX = list(3,3))
...
/datum/seed/mushroom/poison
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1), "amatoxin" = list(3,3), "psilocybin" = list(1,25))
...
/datum/seed/mushroom/poison/death
	...
	mutants = null
	chems = list(REAGENT_ID_NUTRIMENT = list(1,50), "amatoxin" = list(13,3), "psilocybin" = list(1,25))
...
/datum/seed/flower/poppy
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1,20), REAGENT_ID_MORPHINE = list(1,10))
	kitchen_tag = "poppy"
...
/datum/seed/grapes
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1,10), "sugar" = list(1,5), "grapejuice" = list(10,10))
...
/datum/seed/grapes/green
	...
	mutants = null
	chems = list(REAGENT_ID_NUTRIMENT = list(1,10), "grapejuice" = list(10,10))
...
/datum/seed/potato
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1,10), "potato" = list(10,10))
	kitchen_tag = "potato"
...
/datum/seed/wheat
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1,25), "flour" = list(15,15))
	kitchen_tag = "wheat"
...
/datum/seed/whitebeets
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(0,20), "sugar" = list(1,5))
...
/datum/seed/cherries
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1,15), "sugar" = list(1,15), "cherryjelly" = list(10,15))
...
/datum/seed/kudzu
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1,50), REAGENT_ID_ANTITOX = list(1,25))
