...
/obj/item/reagent_containers/glass/rag/attack_self(var/mob/user)
	if(on_fire)
...
/obj/item/reagent_containers/glass/rag/attack(atom/target as obj|turf|area, var/mob/user , flag)
	if(isliving(target))
...
/obj/item/reagent_containers/glass/rag/afterattack(atom/A as obj|turf|area, var/mob/user, proximity)
	if(!proximity)
		return
