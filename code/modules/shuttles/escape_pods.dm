...
/obj/effect/shuttle_landmark/escape_pod/start/New()
	landmark_tag = "escape_pod_[pod_number]_start"
	docking_controller = "escape_pod_[pod_number]_berth"
	..()
...
/obj/effect/shuttle_landmark/escape_pod/transit/New()
	landmark_tag = "escape_pod_[pod_number]_interim"
	..()
...
/obj/effect/shuttle_landmark/escape_pod/out/New()
	landmark_tag = "escape_pod_[pod_number]_out"
	..()
