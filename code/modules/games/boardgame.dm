...
/obj/item/weapon/board/interact(mob/user as mob)
	if(user.is_physically_disabled() || !user.Adjacent(src)) //can't see if you arent conscious. If you are not an AI you can't see it unless you are next to it, either.
