...
/obj/item/deck/attackby(obj/O as obj, var/mob/user)
...
/obj/item/hand/attackby(obj/O as obj, var/mob/user)
	if(istype(O,/obj/item/hand))
		var/obj/item/hand/H = O
...
/obj/item/hand/dropped(var/mob/user)
	..()
...
/obj/item/hand/pickup(var/mob/user)
	src.update_icon()