...
/dmm_suite/proc/splittext_dmm(var/text as text,var/delimiter=",")
	...
	do
		...
		if(equal_position)//associative var, so do the association
			...
			//Check for list
				...
				trim_right = splittext_dmm(copytext(trim_right,6,length(trim_right)))
