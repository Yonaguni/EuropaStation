...
/obj/item/reagent_containers/spray/afterattack(atom/A as mob|obj, var/mob/user, proximity)
...
/obj/item/reagent_containers/spray/proc/Spray_at(atom/A as mob|obj, var/mob/user, proximity)
