...
/obj/item/weapon/reagent_containers/food/snacks/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	if (is_sliceable())
		...
		var/can_slice_here = isturf(src.loc) && ((locate(/obj/structure/table) in src.loc) || (locate(/obj/item/weapon/tray) in src.loc))
...
/obj/item/weapon/reagent_containers/food/snacks/donut/chaos
	...
	New()
		...
		reagents.add_reagent("sprinkles", 1)
		bitesize = 10
		var/list/possible_reagents = list("nutriment","capsaicin","frostoil","sprinkles","coco","slimejelly","banana","berryjuice","tricordrazine")
		reagents.add_reagent(pick(possible_reagents), 3)
