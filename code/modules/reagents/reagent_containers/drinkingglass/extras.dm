/obj/item/reagent_containers/food/drinks/glass2/attackby(obj/item/I as obj, var/mob/user)
...
/obj/item/reagent_containers/food/drinks/glass2/attack_hand(var/mob/user)
