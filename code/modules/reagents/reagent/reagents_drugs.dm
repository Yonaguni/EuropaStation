...
/datum/reagent/antirad/affect_blood(var/mob/living/human/M, var/alien, var/removed)
...
/datum/reagent/jumpstart/affect_blood(var/mob/living/human/M, var/alien, var/removed)
	if(prob(5))
