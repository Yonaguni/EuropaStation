...
var/global/list/whitelisted_species = list(DEFAULT_SPECIES) // Species that require a whitelist check.
var/global/list/playable_species = list(DEFAULT_SPECIES)    // A list of ALL playable species, whitelisted, latejoin or otherwise.

var/list/mannequins_

// Posters
var/list/poster_designs = list()
...
var/global/list/backbaglist = list("Nothing", "Satchel", "Satchel Alt", "Backpack")
