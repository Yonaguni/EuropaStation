...
//	var/enable_authentication = 0		// goon authentication
	...
	var/protect_roles_from_antagonist = 0// If security and such can be traitor/other
	...
	var/cult_ghostwriter = 1               //Allows ghosts to write in blood in spooky rounds...
	...
	var/alert_desc_blue_upto = "We have received reliable information about possible hostile activity on the station. Crew may have weapons visible, random searches are permitted."
	var/alert_desc_blue_downto = "The immediate threat has passed. Crew may no longer have weapons drawn at all times, but may continue to have them visible. Random searches are still allowed."
	var/alert_desc_red_upto = "There is an immediate serious threat to the vessel. Crew may have weapons unholstered at all times. Random searches are allowed and advised."
	var/alert_desc_red_downto = "The self-destruct mechanism has been deactivated. There is still, however, an immediate serious threat present. Crew may have weapons unholstered at all times, random searches are allowed and advised."
	var/alert_desc_delta = "The self-destruct mechanism has been engaged. All passengers are instructed to obey all instructions given by crew. This is not a drill."
	...
	var/list/ert_species = list(DEFAULT_SPECIES)
...
//					config.enable_authentication = 1
				...
				if("ert_species")
					...
					if(!config.ert_species.len)
						config.ert_species += DEFAULT_SPECIES
