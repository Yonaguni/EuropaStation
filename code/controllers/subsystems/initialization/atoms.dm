...
/datum/controller/subsystem/atoms/proc/InitializeAtoms(list/atoms)
	...
	admin_notice("<span class='danger'>Initialized [count] atoms.</span>", R_DEBUG)
	...
	if(late_loaders.len)
		for(var/I in late_loaders)
			var/atom/A = I
			A.LateInitialize()
		admin_notice("<span class='danger'>Late-initialized [late_loaders.len] atoms.</span>", R_DEBUG)
	...
	if(late_qdel.len)
		...
		admin_notice("<span class='danger'>Late-qdeleted [num_qdels] atoms.</span>", R_DEBUG)
