/datum/extension/interactive/multitool/cryo/get_interact_window(var/obj/item/multitool/M, var/mob/user)
	. += buffer(M)
...
/datum/extension/interactive/multitool/cryo/receive_buffer(var/obj/item/multitool/M, var/atom/buffer, var/mob/user)
